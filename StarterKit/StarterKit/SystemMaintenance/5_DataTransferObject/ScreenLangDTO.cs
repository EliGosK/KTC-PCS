 ...
 * 		Time : 03:20 PM
 *  	This is DTO for TZ_SCREEN_LANG_MS Table.
...
{
    [DataTransferObject("TZ_SCREEN_LANG_MS", typeof(eColumns))]
    public class ScreenLangDTO : AbstractDTO
    {
        ...
        private NZString m_strSCREEN_DESC = new NZString();
        ...
        [Field(typeof(System.String), typeof(NZString), DataType.NVarChar, "SCREEN_DESC", 0, 0, 200)]
        public NZString SCREEN_DESC
        {
            get { return m_strSCREEN_DESC; }
            set
            {
                if (value == null)
                    m_strSCREEN_DESC.Value = value;
                else
        ...
        public override MapKeyValue<string, List<string>> PrimaryKey
        {
            get
            {
                ...
                //Add PrimaryKey Name
                return new MapKeyValue<string, List<string>>("SYS_C0026696", values);
            }
        }
        #endregion
