 ...
 * 		Time : 04:40 PM
 *  	This is DTO for TZ_MENU_SET_MS Table.
...
{
    [DataTransferObject("TZ_MENU_SET_MS", typeof(eColumns))]
    public class MenuSetDTO : AbstractDTO
    {
        ...
        private NZString m_strMENU_SET_NAME = new NZString();
        ...
        [Field(typeof(System.String), typeof(NZString), DataType.VarChar, "MENU_SET_NAME", 0, 0, 200)]
        public NZString MENU_SET_NAME
        {
            get { return m_strMENU_SET_NAME; }
            set
            {
                if (value == null)
                    m_strMENU_SET_NAME.Value = value;
                else
                    m_strMENU_SET_NAME = value;
            }
        }
        [FieldNotNull]
        ...
        public override MapKeyValue<string, List<string>> PrimaryKey
        {
            get
            {
                ...
                //Add PrimaryKey Name
                return new MapKeyValue<string, List<string>>("SYS_C0026748", values);
            }
        }
        #endregion
