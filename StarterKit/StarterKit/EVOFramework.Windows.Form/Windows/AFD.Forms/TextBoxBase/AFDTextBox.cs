...
namespace EVOFramework.Windows.Forms
{
    ...
    public abstract class AFDTextBox : TextBoxRoot, IUIDataModelSupport
    {
        ...
        protected AFDTextBox(Behavior behavior)
        {
            m_behavior = behavior;
        }
        ...
        /// </summary>
        [Browsable(false)]
        public virtual object PathValue
        {
            get
            {
                return base.Text;
    ...
    [ToolboxItem(true)]
    public class EVOAlphanumericTextBox : AFDTextBox
    {
        /// <summary>
        ...
        public EVOAlphanumericTextBox(char[] invalidChars)
        {
        ...
        public EVOAlphanumericTextBox(string invalidChars)
        {
            m_behavior = new AlphanumericBehavior(this, invalidChars);
        }
        ...
        public EVOAlphanumericTextBox(AlphanumericBehavior behavior) :
            base(behavior)
        {
        }
    ...
    [ToolboxItem(true)]
    public class EVOMaskedTextBox : AFDTextBox
    {
        /// <summary>
        ...
        public EVOMaskedTextBox(string mask)
        {
        ...
        public EVOMaskedTextBox(MaskedBehavior behavior) :
            base(behavior)
        {
        }
    ...
    [ToolboxItem(true)]
    public class EVONumericTextBox : AFDTextBox
    {
        //public in
        ...
        public EVONumericTextBox(int maxWholeDigits, int maxDecimalPlaces)
        {
        ...
        public EVONumericTextBox(NumericBehavior behavior) :
            base(behavior)
        {
        }
        ...
        public decimal Decimal
        {
            ...
            set
            {
                Text = value.ToString(GetFormatNumber());
            }
        }
        /// <summary>
        ...
        public override object PathValue
        {
            ...
            set
            {
                ...
                base.PathValue = string.Format("{0:" + GetFormatNumber() + "}", value);
            }
        }

        [Browsable(true)]
        [Category("Behavior")]
        [Description("Fix decimal places ex. 0 -> 0.0000")]
        public bool FixDecimalPosition
        {
            get;
            set;
        }

        protected string GetFormatNumber()
        {
            string dd = "#,##0";
            if (MaxDecimalPlaces > 0)
            {
                dd += ".";
                if (this.FixDecimalPosition)
                {
                    dd += string.Empty.PadRight(MaxDecimalPlaces, '0');
                }
                else
                {
        ...
        #region To Value
        public virtual NZDecimal ToNZDecimal()
        {
            return new NZDecimal(this, this.Decimal);
        }

        public virtual NZInt ToNZInt()
        {
            return new NZInt(this, this.Int);
        }
        #endregion
    }
    #endregion
    ...
    [ToolboxItem(true)]
    public class EVOIntegerTextBox : EVONumericTextBox
    {
        /// <summary>
        ...
        ///   The maximum number of digits allowed left of the decimal point.
        ///   If it is less than 1, it is set to 1. </param>
        public EVOIntegerTextBox(int maxWholeDigits) :
            base(null)
        {
        ...
        public EVOIntegerTextBox(IntegerBehavior behavior) :
            base(behavior)
        {
        }
    ...
    [ToolboxItem(true)]
    public class EVOCurrencyTextBox : EVONumericTextBox
    {
        /// <summary>
        ...
        public EVOCurrencyTextBox(CurrencyBehavior behavior) :
            base(behavior)
        {
        }
    }
    ...
    [ToolboxItem(true)]
    public class EVOMultiMaskedTextBox : AFDTextBox
    {
        // Fields
        ...
        /// <seealso cref="Mask" />
        public EVOMultiMaskedTextBox(string mask)
        {
            Mask = mask;
        }
