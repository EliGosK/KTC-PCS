...
{
    internal partial class MenuSubDAO : IMenuSubDAO
    {
        #region Variables
        ...
        /// <returns></returns>
        public int UpdateWithoutPK(Database database, MenuSubDTO data)
        {
            Database db = UseDatabase(database);
            ...
            sb.AppendLine("  ," + MenuSubDTO.eColumns.UPD_DATE + "=SYSDATE");
        ...
        /// <returns></returns>
        public int Delete(Database database, NZString MENU_SUB_CD)
        {
            Database db = UseDatabase(database);
            ...
            string tableName = EVOFramework.Data.DTOUtility.ReadTableName(typeof(MenuSubDTO));
        ...
        /// </summary>
        public bool Exist(Database database, NZString MENU_SUB_CD)
        {
            Database db = UseDatabase(database);
            ...
            sb.AppendLine("  AND " + MenuSubDTO.eColumns.MENU_SUB_CD + "=:MENU_SUB_CD");
            #endregion
        ...
        public List<MenuSubDTO> LoadAll(Database database)
        {
            return LoadAll(database, true,
                MenuSubDTO.eColumns.MENU_SUB_CD
            );
        }
        ...
        /// <returns></returns>
        public List<MenuSubDTO> LoadAll(Database database, bool ascending)
        {
        ...
        /// <returns></returns>
        public List<MenuSubDTO> LoadAll(Database database, bool ascending, params MenuSubDTO.eColumns[] orderByColumns)
        {
            Database db = UseDatabase(database);
            ...
            return db.ExecuteForList<MenuSubDTO>(req);
        }
        ...
        /// <param name="MENU_SUB_CD">Key #1</param>
        /// <returns></returns>
        public MenuSubDTO LoadByPK(Database database, NZString MENU_SUB_CD)
        {
            Database db = UseDatabase(database);
            ...
            List<MenuSubDTO> list = db.ExecuteForList<MenuSubDTO>(req);
