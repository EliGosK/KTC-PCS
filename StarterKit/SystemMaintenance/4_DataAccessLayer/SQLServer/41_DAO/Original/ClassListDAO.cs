...
namespace SystemMaintenance.SQLServer.DAO
{
    internal partial class ClassListDAO : IClassListDAO
    {
        ...
        public int AddNew(Database database, ClassListDTO data)
        {
            ...
            #region Parameters
            req.Parameters.Add("CLS_INFO_CD", DataType.NVarChar, data.CLS_INFO_CD.Value);
            req.Parameters.Add("CLS_CD", DataType.NVarChar, data.CLS_CD.Value);
            req.Parameters.Add("CLS_DESC", DataType.NVarChar, data.CLS_DESC.Value);
            #endregion
        ...
        public int UpdateWithPK(Database database, ClassListDTO data, NZString oldCLS_INFO_CD, NZString oldCLS_CD)
        {
            ...
            req.Parameters.Add("CLS_CD", DataType.NVarChar, data.CLS_CD.Value);
            req.Parameters.Add("CLS_DESC", DataType.NVarChar, data.CLS_DESC.Value);
            req.Parameters.Add("oldCLS_INFO_CD", DataType.NVarChar, oldCLS_INFO_CD.Value);
            req.Parameters.Add("oldCLS_CD", DataType.NVarChar, oldCLS_CD.Value);
            #endregion
        ...
        public int Delete(Database database, NZString CLS_INFO_CD, NZString CLS_CD)
        {
            ...
            DataRequest req = new DataRequest(sb.ToString());
            #region Parameters
            req.Parameters.Add("CLS_INFO_CD", DataType.NVarChar, CLS_INFO_CD.Value);
            req.Parameters.Add("CLS_CD", DataType.NVarChar, CLS_CD.Value);
            #endregion
            return db.ExecuteNonQuery(req);
        }
        #endregion
