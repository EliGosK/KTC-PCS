 ...
 * 		Time : 04:16 PM
 *  	This is DTO for TZ_GROUP_SCREEN_PERMISSION_MS Table.
...
{
    [DataTransferObject("TZ_GROUP_SCREEN_PERMISSION_MS", typeof(eColumns))]
    public class GroupScreenPermissionDTO : AbstractDTO
    {
        ...
        [FieldNotNull]
        [Field(typeof(System.String), typeof(NZString), DataType.VarChar, "GROUP_CD", 0, 0, 60)]
        ...
        public override MapKeyValue<string, List<string>> PrimaryKey
        {
            get
            {
                ...
                values.Add(eColumns.GROUP_CD.ToString());

                //Add PrimaryKey Name
                return new MapKeyValue<string, List<string>>("SYS_C0026887", values);
            }
        }
        #endregion
