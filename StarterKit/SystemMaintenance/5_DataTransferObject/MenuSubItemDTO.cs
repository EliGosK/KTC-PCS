 ...
 *      Team : SI-EVO
 * 		Writed On 2009/09/07
 * 		Time : 11:45 AM
 *  	This is DTO for TZ_MENU_SUB_ITEM_MS Table.
...
{
    [DataTransferObject("TZ_MENU_SUB_ITEM_MS", typeof(eColumns))]
    public class MenuSubItemDTO : AbstractDTO
    {
        ...
        public override MapKeyValue<string, List<string>> PrimaryKey
        {
            get
            {
                ...
                //Add PrimaryKey Name
                return new MapKeyValue<string, List<string>>("SYS_C0026784", values);
            }
        }
        #endregion
        ...
        /*
		public void SaveDTO() {
			MenuSubItemDTO dto = new MenuSubItemDTO();
			dto.MENU_SUB_CD = 
			dto.SCREEN_CD = 
			dto.DISP_SEQ = 
			dto.CRT_BY = 
