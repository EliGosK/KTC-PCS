 ...
 * 		Time : 01:04 PM
 *  	This is DTO for TZ_MENU_SUB_MS Table.
...
namespace SystemMaintenance.DTO
{
    ...
    public class MenuSubDTO : AbstractDTO
    {
        ...
        private NZString m_strMENU_SUB_NAME = new NZString();
        ...
        [Field(typeof(System.String), typeof(NZString), DataType.VarChar, "MENU_SUB_NAME", 0, 0, 120)]
        public NZString MENU_SUB_NAME
        {
            get { return m_strMENU_SUB_NAME; }
            set
            {
                if (value == null)
                    m_strMENU_SUB_NAME.Value = value;
                else
                    m_strMENU_SUB_NAME = value;
            }
        }
        [FieldNotNull]
        ...
        public override MapKeyValue<string, List<string>> PrimaryKey
        {
            get
            {
                ...
                //Add PrimaryKey Name
                return new MapKeyValue<string, List<string>>("SYS_C0026764", values);
            }
        }
        #endregion
