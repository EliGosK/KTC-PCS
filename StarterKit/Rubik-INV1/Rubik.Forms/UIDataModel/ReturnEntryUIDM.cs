...
{
    public class ReturnEntryUIDM : IUIDataModel
    {
        ...
        public ReturnEntryUIDM()
        {
            ...
            DATA_VIEW.Columns.Add("ITEM_DELIVERY_DATE");
            DATA_VIEW.Columns.Add("RETURNABLE_QTY");
            DATA_VIEW.Columns.Add("RETURN_QTY");
            DATA_VIEW.Columns.Add("LOT_QTY");
            DATA_VIEW.Columns.Add("DELIVERY_TRANS_ID");
        }
