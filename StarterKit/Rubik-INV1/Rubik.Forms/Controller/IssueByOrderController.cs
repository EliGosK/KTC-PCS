...
{
    public class IssueByOrderController
    {
        ...
        internal void SaveAddIssueByOrder(List<IssueByOrderUIDM> uidmIssueList)
        {
            ...
            for (int i = 0; i < uidmIssueList.Count; i++)
            {
                ...
                dtoInvTrns.SCREEN_TYPE = DataDefine.ScreenType.IssueByOrder.ToNZString();
        ...
        internal void DeleteTransaction(NZString TransID, NZString RefNo)
        {
            InventoryTransBIZ biz = new InventoryTransBIZ();
            biz.DeleteIssueTransaction(TransID, RefNo);
        }
