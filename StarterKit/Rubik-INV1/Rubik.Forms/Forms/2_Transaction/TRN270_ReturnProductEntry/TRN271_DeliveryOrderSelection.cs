...
{
    [Screen("TRN271", "Delivery Selection", eShowAction.Normal, eScreenType.Screen, "Delivery Selection")]
    public partial class TRN271_DeliveryOrderSelection : CustomizeForm
    {
        #region Enum
        ...
        #region Constructor
        public TRN271_DeliveryOrderSelection()
        {
            InitializeComponent();
        }

        public TRN271_DeliveryOrderSelection(string strLocation, string strCustomer, string strReturnSlipNo, SheetView shtData)
        {
            InitializeComponent();
