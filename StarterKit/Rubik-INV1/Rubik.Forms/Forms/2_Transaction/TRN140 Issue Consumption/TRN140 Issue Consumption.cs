...
{
    //[Screen("TRN140", "Issue Consumption", eShowAction.Normal, eScreenType.Screen, "Issue Consumption")]
    public partial class TRN140 : SystemMaintenance.Forms.CustomizeForm
    {
        #region Enum
            ...
            if (CheckMandatory())
            {
                ...
                if (dr == MessageDialogResult.Yes)
                {
                    ...
                    , dtIssueDate, txtRemark);
                        ClearAll();
                        cboToLoc.SelectedValue = DataDefine.LOCATION_INJECTION;// "INJ";
                        cboFromLoc.SelectedValue = DataDefine.LOCATION_INJECTION_MATERIAL;// "INJRM";
                    }
        ...
        private void InitialScreen()
        {
            ...
            if (m_Mode == eSaveMode.ADD)
            {
                ...
                //argScreenInfo.SYS_GROUP_ID = DataDefine.eSYSTEM_CONFIG..SYS_GROUP_ID;
        ...
        private void ClearAll()
        {
            CommonLib.CtrlUtil.ClearControlData(txtTransactionID, txtItemDesc
                                                ...
                                                , cboForCustomer//, cboSubType
                                                , txtForMachine, txtRefDocNo, txtJobOrderNo);
