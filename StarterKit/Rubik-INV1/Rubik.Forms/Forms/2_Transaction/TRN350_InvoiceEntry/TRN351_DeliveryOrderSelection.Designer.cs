...
{
    partial class TRN351_DeliveryOrderSelection
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.shtView.ColumnHeader.Cells.Get(0, 0).Value = "Delivery No.";
            this.shtView.ColumnHeader.Cells.Get(0, 1).Value = "Group Trans ID.";
            this.shtView.ColumnHeader.Cells.Get(0, 2).Value = "Trans ID.";
            this.shtView.ColumnHeader.Cells.Get(0, 3).Value = "Currency";
            this.shtView.ColumnHeader.Cells.Get(0, 4).Value = "Order No.";
            this.shtView.ColumnHeader.Cells.Get(0, 5).Value = "Order Detail No.";
            this.shtView.ColumnHeader.Cells.Get(0, 6).Value = "PO No.";
            this.shtView.ColumnHeader.Cells.Get(0, 7).Value = "M/N";
            this.shtView.ColumnHeader.Cells.Get(0, 8).Value = "Part No. ";
            this.shtView.ColumnHeader.Cells.Get(0, 9).Value = "Delivery Date";
            this.shtView.ColumnHeader.Cells.Get(0, 10).Value = "Pack No.";
            this.shtView.ColumnHeader.Cells.Get(0, 11).Value = "Lot No.";
            this.shtView.ColumnHeader.Cells.Get(0, 12).Value = "Customer Lot No.";
            this.shtView.ColumnHeader.Cells.Get(0, 13).Value = "Delivery Qty";
            this.shtView.ColumnHeader.Cells.Get(0, 14).Value = "Return Qty";
            ...
            this.shtView.Columns.Get(0).Label = "Delivery No.";
            this.shtView.Columns.Get(0).Tag = "Delivery No.";
            this.shtView.Columns.Get(0).Width = 115F;
            this.shtView.Columns.Get(1).Label = "Group Trans ID.";
            this.shtView.Columns.Get(1).Visible = false;
            this.shtView.Columns.Get(1).Width = 150F;
            this.shtView.Columns.Get(2).Label = "Trans ID.";
            this.shtView.Columns.Get(2).Visible = false;
            this.shtView.Columns.Get(2).Width = 100F;
            this.shtView.Columns.Get(3).Label = "Currency";
            ...
            this.shtView.Columns.Get(5).Label = "Order Detail No.";
            this.shtView.Columns.Get(5).Visible = false;
            this.shtView.Columns.Get(5).Width = 150F;
            this.shtView.Columns.Get(6).AllowAutoFilter = true;
            this.shtView.Columns.Get(6).AllowAutoSort = true;
            this.shtView.Columns.Get(6).Label = "PO No.";
            this.shtView.Columns.Get(6).Tag = "PO No.";
            ...
            this.shtView.Columns.Get(7).Label = "M/N";
            this.shtView.Columns.Get(7).Tag = "Master No.";
            ...
            this.shtView.Columns.Get(9).Label = "Delivery Date";
            this.shtView.Columns.Get(9).Locked = true;
            this.shtView.Columns.Get(9).Tag = "Delivery Date";
            ...
            this.shtView.Columns.Get(10).Locked = false;
            ...
            this.shtView.Columns.Get(11).Label = "Lot No.";
            this.shtView.Columns.Get(11).Tag = "Lot No.";
            ...
            this.shtView.Columns.Get(12).Label = "Customer Lot No.";
            this.shtView.Columns.Get(12).Tag = "Customer Lot No.";
            ...
            this.shtView.Columns.Get(13).Label = "Delivery Qty";
            this.shtView.Columns.Get(13).Tag = "Delivery Qty";
            ...
            this.shtView.Columns.Get(14).Label = "Return Qty";
            this.shtView.Columns.Get(14).Tag = "Return Qty";
            ...
            this.Text = "TRN351: Delivery Selection";
