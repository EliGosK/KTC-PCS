...
{
    [Screen("TRN090", "Delivery List", eShowAction.Normal, eScreenType.ScreenPane, "Delivery List")]
    public partial class TRN090_DeliveryList : SystemMaintenance.Forms.CustomizeListPaneBaseForm
    {
        ...
        private void miExportInvoice_Click(object sender, EventArgs e)
        {
            ExportData();
        }
