...
{
    [Serializable()]
    [DataTransferObject("CUSTOMER_ORDER_VIEW", typeof(eColumns))]
    public class CustomerOrderViewDTO : AbstractDTO
    {
        ...
        [Field(typeof(System.String), typeof(NZString), DataType.NVarChar, "CLS_DESC", 0, 0, 30)]
        ...
        [Field(typeof(System.DateTime), typeof(NZDateTime), DataType.DateTime, "OLD_ITEM_DELIVERY_DATE", 23, 3, 8)]
        public NZDateTime OLD_ITEM_DELIVERY_DATE
        {
            get { return m_dtOLD_ITEM_DELIVERY_DATE; }
            set
            {
                if (value == null)
                    m_dtOLD_ITEM_DELIVERY_DATE.Value = value;
                else
                    m_dtOLD_ITEM_DELIVERY_DATE = value;
            }
        }
        ...
        [Field(typeof(System.Decimal), typeof(NZDecimal), DataType.Number, "OLD_QTY", 16, 6, 9)]
        public NZDecimal OLD_QTY
        {
            get { return m_dOLD_QTY; }
            set
            {
                if (value == null)
                    m_dOLD_QTY.Value = value;
                else
                    m_dOLD_QTY = value;
            }
        }
