...
namespace Rubik.DAO
{
    internal partial class ClassListDAO
    {
        #region Variables
        ...
        public int AddNew(Database database, ClassListDTO data)
        {
            ...
            sb.AppendLine("  ," + ClassListDTO.eColumns.SEQ);
            sb.AppendLine("  ," + ClassListDTO.eColumns.EDIT_FLAG);
            sb.AppendLine(") VALUES(");
            sb.AppendLine("   :CLS_INFO_CD");
            sb.AppendLine("   ,:CLS_CD");
            sb.AppendLine("   ,:CLS_DESC");
            sb.AppendLine("   ,:SEQ");
            sb.AppendLine("   ,:EDIT_FLAG");
            sb.AppendLine(" )");
            #endregion
            ...
            req.Parameters.Add("EDIT_FLAG", DataType.Int32, data.EDIT_FLAG.Value);
        ...
        public int UpdateWithoutPK(Database database, ClassListDTO data)
        {
            ...
            sb.AppendLine("  ," + ClassListDTO.eColumns.SEQ + "=:SEQ");
            sb.AppendLine(" WHERE ");
